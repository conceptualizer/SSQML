...
/**
 * <p>Java class for CastToRefType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CastToRefType">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://www.devspringsoftware.com}SourceAsRefStaticString"/>
 *         &lt;element ref="{http://www.devspringsoftware.com}RightParen"/>
 *         &lt;element ref="{http://www.devspringsoftware.com}WithStaticString"/>
 *         &lt;element ref="{http://www.devspringsoftware.com}CastToRefIdentifier"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CastToRefType", propOrder = {
    "castStaticString",
    "leftParen",
    "sourceAsRefStaticString",
    "rightParen",
    "withStaticString",
    "castToRefIdentifier"
})
public class CastToRefType {
    ...
    @XmlElement(name = "SourceAsRefStaticString", required = true)
    protected SourceAsRefStaticStringType sourceAsRefStaticString;
    ...
    @XmlElement(name = "CastToRefIdentifier", required = true)
    protected ActualIdentifierType castToRefIdentifier;
    ...
    /**
     * Gets the value of the sourceAsRefStaticString property.
     * 
     * @return
     *     possible object is
     *     {@link SourceAsRefStaticStringType }
     *     
     */
    public SourceAsRefStaticStringType getSourceAsRefStaticString() {
        return sourceAsRefStaticString;
    }

    /**
     * Sets the value of the sourceAsRefStaticString property.
     * 
     * @param value
     *     allowed object is
     *     {@link SourceAsRefStaticStringType }
     *     
     */
    public void setSourceAsRefStaticString(SourceAsRefStaticStringType value) {
        this.sourceAsRefStaticString = value;
    }
    ...
    /**
     * Gets the value of the castToRefIdentifier property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public ActualIdentifierType getCastToRefIdentifier() {
        return castToRefIdentifier;
    }

    /**
     * Sets the value of the castToRefIdentifier property.
     * 
     * @param value
     *     allowed object is
     *     {@link ActualIdentifierType }
     *     
     */
    public void setCastToRefIdentifier(ActualIdentifierType value) {
        this.castToRefIdentifier = value;
    }
